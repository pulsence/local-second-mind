...
KNOWN_REPOSITORIES: Dict[str, OAIRepository] = {
    ...
    "philarchive": OAIRepository(
        name="PhilArchive",
        base_url="https://philarchive.org/oai.pl",
        metadata_prefix="oai_dc",
        identifier_prefix="oai:philarchive.org:",
        url_template="https://philarchive.org/rec/{id}",
        description="Open access philosophy preprints and papers",
        min_interval_seconds=2.0,
    ),
    "ssrn": OAIRepository(
        name="SSRN",
        base_url="https://papers.ssrn.com/sol3/oai.cfm",
        metadata_prefix="oai_dc",
        identifier_prefix="oai:ssrn.com:",
        url_template="https://papers.ssrn.com/sol3/papers.cfm?abstract_id={id}",
        description="Social Science Research Network preprints and working papers",
        min_interval_seconds=2.0,
    ),
    "project_muse": OAIRepository(
        name="Project MUSE",
        base_url="http://muse.jhu.edu/oai/",
        metadata_prefix="oai_dc",
        identifier_prefix="oai:muse.jhu.edu:",
        url_template="https://muse.jhu.edu/article/{id}",
        description="Humanities and social sciences journals and books",
        min_interval_seconds=2.0,
    ),
