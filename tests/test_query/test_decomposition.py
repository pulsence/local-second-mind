...
def test_extract_fields_deterministic_author_colon_stops_before_year_clause() -> None:
    fields = extract_fields_deterministic("Find theology documents author: Jane Doe from 2024")
