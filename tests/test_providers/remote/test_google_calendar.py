...
class TestGoogleCalendarProvider(RemoteProviderOutputTest):
    @patch("lsm.remote.providers.communication.google_calendar.OAuth2Client.get_access_token", return_value="token")
