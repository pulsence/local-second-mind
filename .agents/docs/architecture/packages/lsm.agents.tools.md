...
- [read_file.py](../../lsm/agents/tools/read_file.py): File reading tool
- [read_folder.py](../../lsm/agents/tools/read_folder.py): Folder listing tool
- [file_metadata.py](../../lsm/agents/tools/file_metadata.py): File metadata retrieval tool
- [hash_file.py](../../lsm/agents/tools/hash_file.py): File hashing tool
- [source_map.py](../../lsm/agents/tools/source_map.py): Source map generation tool
